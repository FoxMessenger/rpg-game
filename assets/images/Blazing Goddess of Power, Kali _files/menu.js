...
jQuery(window).load(function() {
    ...
    $('#menu>ul>li>a span').css('background-position', 'right -4px');
    $('#menu>ul>li>a.parent span').css('background-position', 'right -49px');
    ...
    // color animation
    $('#menu div a span').css('background-color', 'transparent');
    $('#menu div a.parent span').css('background-position', '-576px bottom');
    $('#menu ul ul a').css('background', 'none').not('.parent').hover(
        function(){
            $(this).stop(true, true).css('backgroundColor', 'rgb(185,136,60)').animate(
                {backgroundColor: 'rgb(147,89,0)'},
                300,
                'easeIn',
                function(){
                    $(this).css('backgroundColor', 'rgb(147,89,0)');
                }
            );
        }, function(){
            $(this).stop(true, true).animate(
                {backgroundColor: 'rgb(185,136,60)'},
                300,
                'easeInOut',
                function(){
    ...
    $('#menu ul ul li').hover(
        function(){
            $('>a.parent', this).stop(true, true).css('backgroundColor', 'rgb(185,136,60)').animate(
                {backgroundColor: 'rgb(147,89,0)'},
                300,
                'easeIn',
                function(){
                    $(this).css('backgroundColor', 'rgb(147,89,0)').find('span').css('background-position', '-960px bottom');
                }
            );
        }, function(){
            $('>a.parent', this).stop(true, true).animate(
                {backgroundColor: 'rgb(185,136,60)'},
                300,
                'easeInOut',
                function(){
                    $(this).css('background', 'none').find('span').css('background-position', '-576px bottom');
                }
            ).find('span').css('background-position', '-576px bottom');
        }
    );
    // images preloading
